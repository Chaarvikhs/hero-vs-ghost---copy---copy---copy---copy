...
statusbars.onStatusReached(StatusBarKind.Energy, statusbars.StatusComparison.EQ, statusbars.ComparisonType.Percentage, 101, function (status) {
    game.over(true)
})
statusbars.onStatusReached(StatusBarKind.Energy, statusbars.StatusComparison.EQ, statusbars.ComparisonType.Percentage, 20, function (status) {
    statusbar.say("Low Fuel 10%")
    music.jumpDown.play()
})
...
mySprite = sprites.create(img`
    ...
    ........................
    `, SpriteKind.Player)
game.showLongText("Hero vs ghost ", DialogLayout.Center)
